...
export const PORTFOLIO_DATA = [
  {
    ...
    description:
      'I build digital experiences that blend creativity, performance, and modern technology. From responsive websites to full-stack applications, I enjoy turning ideas into products that people love using. Always curious, always building, and always looking for the next challenge.',
    skills: [
    ...
    works: [
      { title: 'Full-Stack Web Apps', type: 'React · Next.js · Node.js', accent: '#F4845F' },
      { title: 'UI/UX Development', type: 'Framer Motion · GSAP · Three.js', accent: '#FF6B35' },
      { title: 'Backend & APIs', type: 'Express · Supabase · Firebase', accent: '#E84A5F' },
      { title: 'AI Integration', type: 'AI · Prompt Engineering', accent: '#D4354A' },
      { title: 'Database Design', type: 'MongoDB · MySQL · Supabase', accent: '#C0253A' },
    ],
    experience: [
      {
        ...
        role: 'Full Stack Developer',
        period: 'Current',
        desc: 'Developing and maintaining modern web applications, building scalable frontend and backend solutions, optimizing user experiences, and transforming business requirements into functional digital products.',
      },
    ],
